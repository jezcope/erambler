...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date} {author} (except where noted) - Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a> {license}'
...
RSS_COPYRIGHT = 'Contents © {date} <a href="mailto:{email}">{author}</a> {license} (except where noted)'
RSS_COPYRIGHT_PLAIN = 'Contents © {date} {author} {license} (except where noted)'
...
MARKDOWN_EXTENSIONS = ['fenced_code', 'codehilite', 'extra', 'admonition', 'toc', 'smarty']
